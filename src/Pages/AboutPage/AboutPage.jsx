        ...
        <div className='ABOUT-US-MAIN-CONTAINER'>
                    ...
                    <div className='aboutrightcontainer' >
                          <div className='aboutrightcontent'>
                               <p>Sardar Vallabhbhai Patel Institute Of Technology, Vasad,Has Emerged As The Chieftain Among The Premiere Institutes Of Gujrat For The Last 25 Years.Prakarsh Is One Of The Most Recognized Symposiums All Over Gujrat.</p>
                              <p>
