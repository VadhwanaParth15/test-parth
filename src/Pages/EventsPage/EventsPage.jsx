  ...
  return (
    <>
      <div className='EVENTS_CONTAINER'>
        ...
        <p className='EVENTS_HEADING_MAIN'>come join the thrill,bring your friends too.</p>
        <div className='EVENTS_FLEX_CONTAINER'>
          {Events.map(members => <EventsName item={members} src={members.EventimageSource} EventDiscription={members.EventDiscription} key={members.key} />)}
        </div>
      </div>
    </>
  )
